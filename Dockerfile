...
# The entrypoint is not set here because the command is overridden by the Helm chart
# Just setting a default for local testing
CMD ["python", "src/etl_vectordb.py"]
